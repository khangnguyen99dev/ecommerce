        ...
        let html='';
                ...
                html+=`<div class="home-product-item__action">
                    ...
                    <div class="home-product-item__origin">
                        <span class="home-product-item__brand"> ${product.nameCategory} </span>
                        <span class="home-product-item__origin-name">${product.nameProductType} </span>
                    </div>`;
                    if(product.react>0){
                ...
                btn[i].addEventListener('click', (e) => {
                    ...
                    if(data.length!= 0) {               
                        ...
                        if(check == 'all-product') {
                            ...
                            toastr["info"](message+' hiện không có sản phẩm!');
                        }               
                    }   
                })
            }            
                ...
                btn[i].addEventListener('click', (e) => {
                    ...
                    if(data.length != 0) {
                        ...
                        if(check == 'all-product') {
                            ...
                            const message = e.target.parentNode.textContent;
                            toastr["info"](message+' hiện không có sản phẩm!');
                        }  
                    }
                })
