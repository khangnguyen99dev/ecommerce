            ...
            <div class="auth-form__container">
                ...
                <div class="auth-form__groups">
                    <div class="auth-form__group form-group">
                        ...
                        <input class="auth-form__input" rules="required|min:2"  placeholder="Nhập tên của bạn" id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus />
                        <span class="form-message"></span>
                    </div>
                    <div class="auth-form__group form-group">
                        <label for="email" class="auth-form__label">Email</label>
                        <input class="auth-form__input" rules="required|email|check_email" placeholder="Email của bạn" id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" />
                        <span class="form-message"></span>
                    </div>
                    <div class="auth-form__group form-group">
                        <label for="password" class="auth-form__label">Mật khẩu</label>
                        <input class="auth-form__input" rules="required|min:6" placeholder="Mật khẩu của bạn" id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" />
                        <span class="form-message"></span>
                    </div>
                    <div class="auth-form__group form-group">
                        <label for="password_confirmation" class="auth-form__label">Nhập lại mật khẩu</label>
                        <input class="auth-form__input" rules="required|min:6|password_confirm" placeholder="Nhập lại mật khẩu của bạn" id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" />
                        <span class="form-message"></span>
                    </div>
                </div>
