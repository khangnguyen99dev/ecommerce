    ...
    <div class="auth-form__container">
        ...
        <div class="auth-form__groups">
            <div class="auth-form__group">
                ...
                <input class="auth-form__input" placeholder="Email của bạn"  id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus />
                @error('email')
            ...
            <div class="auth-form__group">
                ...
                <input class="auth-form__input" placeholder="Mật khẩu của bạn"  id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" />
                @error('password')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <div class="auth-form__aside">
            ...
            @if (Route::has('password.request'))
                <a href="{{ route('password.request') }}" class="auth-form__help-link auth-form__help-forgot">Quên mật khẩu</a>
            @endif
