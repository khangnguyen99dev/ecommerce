    ...
    <div class="grid wide">
        <nav class="header__navbar hide-on-mobile-tablet">
            <ul class="header__navbar-list">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 384 384" style="enable-background:new 0 0 384 384; width: 14px;" xml:space="preserve">
                <g>
                    <g>
                        <path fill="#fff" d="M353.188,252.052c-23.51,0-46.594-3.677-68.469-10.906c-10.719-3.656-23.896-0.302-30.438,6.417l-43.177,32.594    c-50.073-26.729-80.917-57.563-107.281-107.26l31.635-42.052c8.219-8.208,11.167-20.198,7.635-31.448    c-7.26-21.99-10.948-45.063-10.948-68.583C132.146,13.823,118.323,0,101.333,0H30.813C13.823,0,0,13.823,0,30.813    C0,225.563,158.438,384,353.188,384c16.99,0,30.813-13.823,30.813-30.813v-70.323C384,265.875,370.177,252.052,353.188,252.052z"/>
                    </g>
                </g>
                </svg>  
                0911904945
            ...
            <ul class="header__navbar-list">
                            ...
                            <li class="header__notify-item header__notify-item--viewed">
                                <a href="" class="header__notify-link">
                                    ...
                                    <div class="header__notify-info">
                                        <span class="header__notify-name">Phuộc YSS</span>
                ...
                @if(Auth::check())
                   ...
                   <div class="header__navbar-user-img" style="background-image: url(http://kanestore.com/assets/img/upload/avatar/{{ Auth::user()->avatar }});"></div>
                        <!-- <img src="assets/img/upload/avatar/{{ Auth::user()->avatar}}" class="header__navbar-user-img"></img> -->
                        <span class="header__navbar-user-name">{{ Auth::user()->name}}</span>
                        <ul class="header__navbar-user-menu">
                            <li class="header__navbar-user-item">
                                <a href="{{ route('customer.index')}}">Tài khoản của tôi</a>
                            </li>
                            <li class="header__navbar-user-item">
                                <a href="{{ route('customer.address') }}">Địa chỉ của tôi</a>
                            </li>
                            <li class="header__navbar-user-item">
                                <a href="{{ route('customer.purchased',['key'=>'all']) }}">Đơn mua</a>
                            </li>
            ...
            <div class="header-with-search">
                ...
                <div class="header__search" >
                    <div class="header__search-input-wrap" >
                        <input type="text" class="header__search-input" name="query" placeholder="Nhập để tìm kiếm.." id="search"></input>
                        <!-- Search history -->
                    ...
                    <button class="header__search-btn js-btn-search" >
