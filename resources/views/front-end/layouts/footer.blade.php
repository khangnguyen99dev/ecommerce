<footer class="footer">
        ...
        <div class="row">
            <div class="col l-2-4 m-4 c-6">
                ...
                <ul class="footer-list">
                    ...
                    <li class="footer-item">
                        <a href="" class="footer-item__link">Kane Store</a>
                    </li>
                    <li class="footer-item">
            ...
            <div class="col l-2-4 m-4 c-6">
                ...
                <ul class="footer-list">
                    <li class="footer-item">
                        <a href="" class="footer-item__link">Phụ tùng xe máy</a>
                    </li>
                    <li class="footer-item">
                        <a href="" class="footer-item__link">Nhớt xe</a>
                    </li>
                    <li class="footer-item">
                        <a href="" class="footer-item__link">Đồ chơi xe máy</a>
                    </li>
                </ul>
            </div>
            <div class="col l-2-4 m-4 c-6">
    ...
    <div class="footer__bottom">
        <div class="grid wide">
            <p class="footer__text">Cửa hàng phụ tùng xe máy Kane Store</p>
        </div>
    </div>
</footer>