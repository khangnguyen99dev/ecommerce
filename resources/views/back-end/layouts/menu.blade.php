<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a href="{{ route('order') }}" class="nav-link"><i class="fas fa-list"></i> Đặt hàng</a>
    </li>

    <li class="nav-item">
        <a href="{{ route('banner') }}" class="nav-link"><i class="fas fa-list"></i>Banner</a>
    </li>

    <li class="nav-item">
        <a href="{{ route('slider') }}" class="nav-link"><i class="fas fa-list"></i>Slider</a>
    </li>
